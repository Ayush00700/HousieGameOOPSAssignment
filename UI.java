...
class Dealer implements Runnable {
	...
	public void run() {
        ...
        synchronized(gameData.lock1)
		{
			...
			if(gameData.playerSuccessFlag[1]&& !gameData.playerSuccessFlag[0])
...
class GameGUI implements ActionListener{
	...
	GameGUI(GameData gameData, Dealer dealer, Players player1, Players player2) {
...
class GameApp {
	...
	public static void main(String[] args) {
		...
		final Players player1 = new Players(game, 0);
		final Players player2 = new Players(game, 1);
